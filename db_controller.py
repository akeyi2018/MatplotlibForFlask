        ...
        data = [
            {
                "id": 2,
                "user_id": 1,
                "measure_date": date(2024, 2, 25),
                "systolic_blood_pressure": 165,
                "diastolic_blood_pressure": 121,
                "pulse": 75,
                "weight": Decimal("77.00"),
            },
            {
                "id": 3,
                "user_id": 1,
                "measure_date": date(2024, 2, 26),
                "systolic_blood_pressure": 168,
                "diastolic_blood_pressure": 119,
                "pulse": 76,
                "weight": Decimal("77.00"),
            },
            {
                "id": 4,
                "user_id": 1,
                "measure_date": date(2024, 2, 27),
                "systolic_blood_pressure": 162,
                "diastolic_blood_pressure": 119,
                "pulse": 75,
                "weight": Decimal("77.40"),
            },
            {
                "id": 5,
                "user_id": 1,
                "measure_date": date(2024, 2, 28),
                "systolic_blood_pressure": 170,
                "diastolic_blood_pressure": 120,
                "pulse": 84,
                "weight": Decimal("76.60"),
            },
            {
                "id": 6,
                "user_id": 1,
                "measure_date": date(2024, 2, 29),
            ...
            },
            {
                "id": 7,
                "user_id": 1,
                "measure_date": date(2024, 3, 1),
                "systolic_blood_pressure": 153,
                "diastolic_blood_pressure": 112,
                "pulse": 74,
                "weight": Decimal("76.90"),
            },
            {
                "id": 8,
                "user_id": 1,
                "measure_date": date(2024, 3, 2),
                "systolic_blood_pressure": 162,
            ...
            },
            {
                "id": 10,
                "user_id": 1,
                "measure_date": date(2024, 3, 4),
                "systolic_blood_pressure": 158,
                "diastolic_blood_pressure": 114,
                "pulse": 82,
                "weight": Decimal("77.30"),
            },
            {
                "id": 11,
                "user_id": 1,
                "measure_date": date(2024, 3, 5),
                "systolic_blood_pressure": 153,
                "diastolic_blood_pressure": 112,
                "pulse": 78,
                "weight": Decimal("76.90"),
            },
            {
                "id": 12,
                "user_id": 1,
                "measure_date": date(2024, 3, 6),
                "systolic_blood_pressure": 154,
                "diastolic_blood_pressure": 112,
                "pulse": 78,
                "weight": Decimal("76.60"),
            },
            {
                "id": 13,
                "user_id": 1,
                "measure_date": date(2024, 3, 7),
                "systolic_blood_pressure": 150,
                "diastolic_blood_pressure": 108,
                "pulse": 73,
                "weight": Decimal("76.80"),
            },
            {
                "id": 14,
                "user_id": 1,
                "measure_date": date(2024, 3, 8),
                "systolic_blood_pressure": 138,
                "diastolic_blood_pressure": 106,
                "pulse": 79,
                "weight": Decimal("76.80"),
            },
            {
                "id": 15,
                "user_id": 1,
                "measure_date": date(2024, 3, 9),
                "systolic_blood_pressure": 141,
            ...
            },
            {
                "id": 16,
                "user_id": 1,
                "measure_date": date(2024, 3, 10),
                "systolic_blood_pressure": 142,
                "diastolic_blood_pressure": 105,
                "pulse": 76,
                "weight": Decimal("76.80"),
            },
            {
                "id": 17,
                "user_id": 1,
                "measure_date": date(2024, 3, 11),
                "systolic_blood_pressure": 137,
                "diastolic_blood_pressure": 108,
                "pulse": 74,
                "weight": Decimal("77.10"),
            },
            {
                "id": 18,
                "user_id": 1,
                "measure_date": date(2024, 3, 12),
                "systolic_blood_pressure": 136,
                "diastolic_blood_pressure": 103,
                "pulse": 80,
                "weight": Decimal("76.60"),
            },
            {
            ...
            },
            {
                "id": 26,
                "user_id": 1,
                "measure_date": date(2024, 3, 16),
                "systolic_blood_pressure": 137,
                "diastolic_blood_pressure": 101,
                "pulse": 77,
                "weight": Decimal("76.40"),
            },
            {
                "id": 28,
                "user_id": 1,
                "measure_date": date(2024, 3, 17),
                "systolic_blood_pressure": 137,
                "diastolic_blood_pressure": 101,
                "pulse": 88,
                "weight": Decimal("76.70"),
            },
            {
                "id": 29,
                "user_id": 1,
                "measure_date": date(2024, 3, 18),
            ...
            },
            {
                "id": 30,
                "user_id": 1,
                "measure_date": date(2024, 3, 19),
                "systolic_blood_pressure": 132,
                "diastolic_blood_pressure": 100,
                "pulse": 75,
                "weight": Decimal("76.30"),
            },
            {
                "id": 31,
                "user_id": 1,
                "measure_date": date(2024, 3, 20),
                "systolic_blood_pressure": 130,
                "diastolic_blood_pressure": 96,
                "pulse": 76,
                "weight": Decimal("76.50"),
            },
            {
                "id": 32,
                "user_id": 1,
                "measure_date": date(2024, 3, 21),
                "systolic_blood_pressure": 126,
                "diastolic_blood_pressure": 96,
                "pulse": 76,
                "weight": Decimal("76.20"),
            },
            {
                "id": 33,
                "user_id": 1,
                "measure_date": date(2024, 3, 22),
                "systolic_blood_pressure": 126,
                "diastolic_blood_pressure": 96,
                "pulse": 77,
                "weight": Decimal("76.50"),
            },
            {
                "id": 34,
                "user_id": 1,
                "measure_date": date(2024, 3, 23),
                "systolic_blood_pressure": 133,
                "diastolic_blood_pressure": 93,
                "pulse": 72,
                "weight": Decimal("76.40"),
            },
            {
...
class Event_info(db.Model):
    ...
    def set_data(cls):
        data = [
            ...
            {
                "user_id": 1,
                "event_name": "メンター相談VBA",
                "event_date": date(2024, 3, 30),
                "discription": "VBA相談 10:00から",
            },
            {
                "user_id": 1,
                "event_name": "箱根旅行",
                "event_date": date(2024, 4, 26),
                "discription": "健康保険組合保養所で宿泊",
            },
            {
                "user_id": 1,
                "event_name": "派遣入場",
                "event_date": date(2024, 4, 2),
                "discription": "入場横浜",
            },
            {
                "user_id": 1,
            ...
            {
                "user_id": 1,
                "event_name": "iPhone返却期限",
                "event_date": date(2025, 6, 30),
                "discription": "ドコモショップへ返却する",
            },
            {
                "user_id": 1,
                "event_name": "お小遣い帳機能追加",
                "event_date": date(2024, 3, 23),
                "discription": "お小遣い帳の追加検討",
            },
        ]
        # データベースへの挿入
        for entry in data:
